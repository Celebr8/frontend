	...
	return (
		...
		<section className={css.getInTouch}>
			<div className={css.btnGroup + ' ' + css.containerButton}>
          	...
          	<a href="https://www.whichost.com/s?address=Ireland&bounds=55.36%2C-5.911%2C51.427%2C-10.382&origin=53.357%2C-7.756"><button type="submit">Find a pub for your birthday</button></a>
					</section>
				</div>
			</section>
