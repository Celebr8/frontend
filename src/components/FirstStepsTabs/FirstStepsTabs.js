...
const ForUser = () => (
  <TabContainer>
    ...
    <p>
      ...
      <NamedLink name="BirthdayDealPage">Birthday Deal</NamedLink> page and have a great time on us!{' '}
      <i>(T&Cs apply)</i>
    </p>
    <h2>Are you part of a corporation? Reward your colleagues!</h2>
    <p>
      We have a great deal for your corporation! Check out our{' '}
      <NamedLink name="CorporateDealPage">Corporate Benefit</NamedLink> page and reward your
      employees and colleagues now! <i>(T&Cs apply)</i>
    </p>
    <h2>Contact us. We're here to help.</h2>
    <p>If you're ready to start saving time but you still have questions that are not covered by our <a href="https://www.celebr8.co/help/faq" target="_blank" rel="noopener noreferrer">help center</a>, we invite you to <a href="https://www.celebr8.co/help/contact-us" target="_blank" rel="noopener noreferrer">contact us</a> and we'll assist you personally.</p>
    <br/>
	</TabContainer>
)
...
//   <p>
//     <ol>
//       <li>Create a profile by clicking on <a href="https://www.celebr8.co/signup" target="_blank" rel="noopener noreferrer">Sign up</a>;</li>
//       <li>Enter the needed information and click on the button "Sign up";</li>
...
//       <li>Click on <a href="https://www.celebr8.co/l/new" target="_blank" rel="noopener noreferrer">+ Add your pub</a>;</li>
...
//       <li>Done;</li>
//       <li><i>(optional)</i><a href="https://www.celebr8.co/help/contact-us" target="_blank" rel="noopener noreferrer"> Contact us</a> in case you have further questions.</li>
//     </ol>
//   </p>
//   <br/>
...
//   <br/>
//   <h2>Contact us. We're here to help.</h2>
//   <p>If you're ready to start but you still have questions that are not covered by our <a href="https://www.celebr8.co/help/faq" target="_blank" rel="noopener noreferrer">help center</a>, we invite you to <a href="https://www.celebr8.co/help/contact-us" target="_blank" rel="noopener noreferrer">contact us</a> and we'll assist you personally.</p>
//   <br/>
//   </TabContainer>
// );
  ...
  <TabContainer>
    ...
    <p>
      <ol>
        ...
        <li>
          <i>(optional)</i>
          <NamedLink name="ContactUsPage"> Contact us</NamedLink> in case you have further
          questions.
        </li>
      </ol>
    </p>
