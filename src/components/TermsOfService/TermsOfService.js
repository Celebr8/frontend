...
const TermsOfService = props => {
  ...
  return (
    <div className={classes}>
      ...
      <p>
        Celebr8 is an online marketplace that allows you to discover and book pubs and also offer your pub to customers. Please read our service agreement carefully below prior to using our marketplace and its services as it governs your use of our platform.
		</p>
		<p>
			<strong>
Importantly, this Usage Agreement contains waivers of class actions and jury trials and an agreement to submit all claims and disputes to binding arbitration in Part 4 below. If you do not agree to all the terms and conditions of this Usage Agreement, including those governing disputes in Part 4, you may not use our platform or services.
      ...
      <p>
        This Celebr8 Services Agreement (“Agreement”) is a contract between Whichost Ltd. (“Celebr8” or “we”) and the person(s) that are registered with Celebr8 (“user” or “you”). This Agreement describes the terms and conditions that apply to your use of the Celebr8 marketplace to book or list pubs or other pub services through our website or apps, and governs your pub for other users, and establishes the obligations owed between you and Celebr8, and between you and other users.
		</p>
		<p>
...
This Agreement is organized into 5 parts:
		...
		<p>
			<strong>Part 1: General Terms</strong> includes general terms describing your Account including creating an account, accepting or making payments, and describing how we communicate with you.
			</p>
		<p>
			<strong>Part 2: Platform and Service</strong> describe how you may and may not use the Platform and Service, and also describes how we use any data.
		</p>
		<p>
			<strong>Part 3: Celebr8 Services</strong> establishes the obligations of Pubs, including how to List a Pub and what is expected of any Pub Listed through the Service; and the obligations of Customers, including Booking a Pub, expected behaviour, responsibility for payment of Fees, and Booking other services.
			</p>
		<p>
<strong>Part 4: Termination, Disputes, and Binding Arbitration</strong> describe termination or suspension of this Agreement or your Account, and the process of resolving any disputes. This section contains waivers of both class actions and jury trials, and an agreement to submit all claims and disputes to binding arbitration. Please read this section carefully before accepting this Agreement –you may not use the Platform or Services if you do not agree to this section.
		</p>
		<p>
			<strong>Part 5: Additional Legal Terms</strong> provides additional legal terms including our ability to update this Agreement, disclaimers and limitations on our liability, and some specific terms for users outside of Ireland. It also includes other documents governing your use of the Services including our Community Guidelines, Fees, Privacy Policy, and Cancellation and Refund Policy.
		</p>
		<p>
If you have questions about this Agreement, please contact us at <a href="mailto:support@celebr8.co">support@celebr8.co</a>. Your use of the Platform or Services constitutes your ongoing acceptance of this Agreement, as amended.
		</p>
		
      <h2>Part 1: General Terms</h2>
      <h3><strong>1.1 SERVICES</strong></h3>
      <p>
        Celebr8 provides you access to Services through the Platform. You may access the Platform through our website or apps. You may use the Service to List Pubs, Book Pubs as a Customer, communicate with other users and access your Account.
		</p>
  <p>
        You may also be permitted to make use of the Celebr8 Benefits, such as the <a href="https://www.celebr8.co/benefits/birthday-gift">Birthday Gift</a>, the <a href="https://www.celebr8.co/benefits/corporate-benefit">Corporate Benefit</a> and the <a href="https://www.celebr8.co/benefits/recommend-gift">Recommend Reward</a>, and other benefits that Celebr8 may implement in the future. You agree that your acceptance of this Celebr8 Terms of Service is also an acceptance of the terms and conditions that govern each of Celebr8 Benefits. 
		</p>
          <p>
You may also be permitted to Book Pub Services (“Pub Services”) through third-party service providers or through the Pub, which may require you to agree to additional terms or conditions. These Pub Services may include Audio Engineering, Production, or other Services that can take place in the Pubs. This is however not the main marketplace Service provided by Celebr8.
		</p>
		<p>
...
At our sole option, we may suspend or terminate your Account.
      ...
      <h3><strong>1.4 FEES AND TAXES</strong></h3>
      <p>
      <strong>(a) Fees, Overtime</strong>. You are responsible for payment of fees, expenses, and other amounts related a to Booking (“Fees”). Fees include amounts paid to Celebr8, Pubs, and Pub Services and as described in our Fees Overview. Celebr8 receives Fees for providing use of the Service, and Pubs receive Fees for Bookings. The specific Fees charged are presented when you request, complete, and pay for a Booking. Please review the Pubs individually listed cancellation policy on their Listing prior to submitting a Booking request. You should contact Pubs through the Platform before Booking if you don’t understand the Fees listed or their cancellation policy that will be applicable. Please email us at <a href="mailto:support@celebr8.co">support@celebr8.co</a> at any time if you do not understand Fees or have questions regarding them.
	  </p>
	  <p>
...
We may change or add other payment processing services at any time upon notice to you, which may be subject to additional terms or conditions.
	...
	<h3><strong>1.6 COMMUNICATION AND NOTICES</strong></h3>
      <p>
	  ...
	  <p>
We may send you notices to the email address or physical address included in your Account, through messaging on the Platform. You may send any notices to us at <a href="mailto:support@celebr8.co">support@celebr8.co</a>. You agree that any email notice from us is considered accepted by you one day after such notice was sent and will have the same legal effect as if it were physically delivered to you.
		</p>
		<p>
You agree to receive any communications from us and transact with us electronically. This acceptance of emails or other electronic messages constitutes your consent and your electronic signature has the same legal effect as physically signing a document. You may withdraw this consent to transact electronically at any point by providing notice to us. However, given that electronic communication is integral to the Platform and the Services, following any such notice we may elect to close your Account.
	...
	<p>
If you have problems communicating receiving messages, please first please contact us at <a href="mailto:support@celebr8.co">support@celebr8.co</a>.
	</p> 
	
	<h3><strong>1.7 COMMUNICATION WITH OTHER USERS</strong></h3>
      <p>
...
Any judgment on the award rendered by the arbitrator may be entered in any court having jurisdiction.
		...
		<p>
<strong>(b) Certain Claims Excluded</strong>. Notwithstanding Part 4.2(a), the parties agree that any claims based on ownership or misuse of the other party’s intellectual property—including patents, copyrights, or trademarks—may be brought before the courts in Ireland. Either party may also seek provisional remedies for injunctive relief under such claims from a court of competent jurisdiction.
		</p>
		<p>
<strong><i>(c) Class Action and Jury Waiver</i>. Each party agrees that any action or claim arising from or related to this Agreement or any Booking Agreement may only be brought on an individual basis and not part of a class action or consolidated arbitration, or join claims with other users or third parties. Further, each party expressly waives its right to a jury in arbitration and court, where permitted. You may opt-out of this class action and jury waiver described in Part 4.2(c) by emailing us at <a href="mailto:support@celebr8.co">support@celebr8.co</a> within 30 days of your first use of the Platform or Services. You must include your name, phone number, physical address, and email address in your opt-out notice. This is your only mechanism for opting out of this Part 4.2(c) and failure to do so as described constitutes your consent to this waiver. If you choose to opt out of this Part 4.2(c), please note that all other provisions of this Agreement will remain intact and in full force and effect.</strong>
		</p>
		<p>
<strong>(d) Conflict of Rules</strong>. If any provision of this Part 4.2 is found to be invalid or unenforceable, the reviewing court or arbitrator, as applicable, will interpret or revise the provisions only as minimally necessary to comply with Law. All the other provisions will remain enforceable and intact as written.
    	</p>
    	
    	<h3><strong>4.3 DISPUTES BETWEEN USERS</strong></h3>
    	<p>
    	<strong>This section describes how disputes or claims arising under this Agreement between you and another user will be resolved. Please read this section carefully before accepting this Agreement—you may not use the Platform or Services if you do not agree to this section.</strong>.
    	</p>
    	<p>
    	<strong>(a) Initial User Dispute Resolution</strong>. You agree to first attempt to resolve any disputes, disagreements, or claims that you have with other users (“User Dispute”) in good faith through the Platform. If you are unable to resolve the User Dispute, you then will submit the User Dispute to us at <a href="mailto:support@celebr8.co">support@celebr8.co</a>. In our sole discretion, we may (i) require that you submit additional details regarding any User Dispute, and/or (ii) hold any pending payments or reverse any payments already made to you and hold such payments pending final resolution of the User Dispute. We will review the summary and communications made on the Platform. We may, but are not required to, also review communications made outside of the Platform. Upon review and investigation, we will either (a) provide you and the other user our conclusion based on the summary provided, which you agree to accept as final and binding determination with the same force and effect as if determined through arbitration as provided in Part 4.2; or (b) require that the dispute is resolved through binding arbitration adjudicated by a third party as provided in Part 4.2(a). The party filing the User Dispute will be responsible for payment of any costs associated with that filing, including costs borne by Celebr8. As a part of the User Dispute, you may also seek to recover these costs if you prevail. Any payments held by Celebr8 pending final resolution of a User Dispute shall be disbursed by Celebr8 as determined by Celebr8, the arbitrator, or a court of competent jurisdiction.
    	</p>
    	<p>
    	<strong>(b) User Disputes Under €25,000</strong>. After following the process outlined above, if the User Dispute relates to an amount reasonably less than €25,000, you agree to submit the User Dispute to binding arbitration as provided in Part 4.2(a)(i) above.
    	</p>
    	<p>
    	<strong>(c) User Disputes of €25,000 or higher</strong>. After following the process outlined above, if the User Dispute relates to an amount reasonably €25,000 or more, you agree to submit the User Dispute to binding arbitration as provided in Part 4.2(a)(ii) above.
    	</p>
    	
    	<h3><strong>4.4 CONFIDENTIALITY OF PROCEEDINGS</strong></h3>
    	<p>
    	...
    	<h2>Part 5: Additional Legal Terms</h2>
		<h3><strong>5.1 RIGHT TO AMEND</strong></h3>
		<p>
		...
		<h3><strong>5.2 CANCELLATIONS</strong></h3>
		<p>
		Celebr8 is not responsible or liable for nonperformance caused by communication failures or nonperformance of Pubs.
		</p>
		<p>
Cancellations of Bookings, whether with or without cause or caused by events outside of your reasonable control, are subject to individual Pub Listing Cancellation and Refund Policy. Please review it carefully before Booking a Pub or Pub Services.
		...
		<h3><strong>5.3 NO ASSIGNMENT</strong></h3>
		<p>
...
THE PLATFORM AND SERVICES ARE PROVIDED TO YOU ON AN “AS IS” AND “AS AVAILABLE” BASIS WITHOUT ANY GUARANTEE OR WARRANTY OF ANY KIND, EXPRESSED OR IMPLIED, INCLUDING WITHOUT LIMITATION WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, SUITABILITY FOR YOUR PARTICULAR USE, OR NONINFRINGEMENT. WITHOUT LIMITING THE FOREGOING, WE DISCLAIM THAT THE PLATFORM OR SERVICES ARE FREE FROM ERROR OR VIRUSES; THAT THEY WILL NEVER CAUSE HARM; THAT THEY MEET OR BE SUITABLE FOR YOUR NEEDS OR REQUIREMENTS; THAT THEY ARE ALWAYS AVAILABLE; OR THAT THEY ACCURATELY REPRESENT PUBS OR PUB SERVICES PROVIDERS. WE EXPRESSLY DISCLAIM ANY OBLIGATION TO CORRECT ERRORS, EVEN THOSE THAT WE ARE AWARE OF, AND MAY CHOOSE TO DISCONTINUE OPERATION OF THE PLATFORM OR SERVICE, OR FEATURES OF EITHER, AT ANY TIME.
		...
		<h3><strong>5.5 REPRESENTATIONS AND WARRANTIES</strong></h3>
		<p>
...
When using the Platform or Services as a Customer, you further represent and warrant that (i) you will comply with any Booking Agreements; (j) you will not use Pubs or Pubs Services in a manner that violates Laws or Community Guidelines, or that facilitates the violation of either by third parties; and (k) that any payment Credentials provided to us may be used as described in this Agreement.
    	...
    	<h3><strong>5.6 INDEMNITIES</strong></h3>
		<p>
    	You will indemnify, defend and hold Celebr8 and its owner(s), agents, members, information providers, attorneys, or affiliates (collectively, “Celebr8 Affiliates”) harmless against all third-party claims, liabilities, losses, damages, and related expenses (including reasonable legal expenses) (collectively, “Claims”) arising from or related to (a) provision of your Pub (for Pubs) or Pub Service (for Pubs), or use of Pubs or Pub Services (for Customers); (b) Content you provide through the Platform; (c) your failure to comply with Laws; (d) your providing of information to us that is inaccurate or incomplete, (e) your breach of any of your obligations under this Agreement, and (f) any contract or other agreement between you and any other user other than through the Platform. This indemnification will survive termination of this Agreement.
    	</p>
    	
    	<h3><strong>5.7 LIMITATIONS OF LIABILITY</strong></h3>
		<p>
    	EXCEPT TO THE LIMITED EXTENT OF THE CELEBR8 FEES (AS DEFINED BELOW) UNDER NO CIRCUMSTANCES OR ANY LEGAL THEORY WILL CELEBR8 OR ITS OWNERS, AGENTS, MEMBERS, INFORMATION PROVIDERS, ATTORNEYS, OR AFFILIATES BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DAMAGES (WHETHER DIRECT, INDIRECT, GENERAL, COMPENSATORY, INCIDENTAL, CONSEQUENTIAL, SPECIAL, PUNITIVE, EXEMPLARY OR OTHERWISE), INJURY, CLAIM OR LIABILITY OF ANY KIND OR CHARACTER BASED UPON OR ARISING FROM YOUR USE OF OR INABILITY TO USE THE PLATFORM OR SERVICES, OR PUBS OR PUB SERVICES, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF DAMAGES. IF YOU ARE DISSATISFIED WITH THE PLATFORM OR SERVICES, OR ANY CONTENT CONTAINED THEREIN, YOUR SOLE AND EXCLUSIVE REMEDY IS TO DISCONTINUE USING THE PLATFORM AND SERVICES.
		</p>
		<p>
AS USED HEREIN, “CELEBR8 FEES” SHALL MEAN THE AMOUNT PAID BY YOU TO CELEBR8, EXCLUDING ANY AMOUNTS THAT WERE PAID OR PAYABLE TO PUBS OR PUB SERVICES, FOR USE OF THE PLATFORM OR SERVICES.
		</p>
		<p>
THE LIMITATION OF LIABILITY SET FORTH ABOVE APPLIES TO THE EXTENT PERMITTED BY LAW.
		</p>
		
		<h3><strong>5.8 ADDITIONAL TERMS FOR USERS OUTSIDE IRELAND</strong></h3>
		<p>
		...
		<h3><strong>5.9 ENTIRE AGREEMENT; INTERPRETATION</strong></h3>
		<p>
		This Agreement together with any Booking Agreement constitutes the entire agreement between you and Celebr8 governing your use of the Platform or Services. This Agreement supersedes all prior understandings or agreements between you and Celebr8. As between you and Celebr8, this Agreement controls over any conflicting terms in a Booking Agreement except where expressly stated otherwise and agreed upon in writing between the parties.
		</p>
		<p>
