...
This Agreement is organized into 5 parts:
		...
		<p>
			<strong>Part 3: Whichost Services</strong> establishes the obligations of Pubs, including how to List a Pub and what is expected of any Pub Listed through the Service; and the obligations of Customers, including Booking a Pub, expected behaviour, responsibility for payment of Fees, and Booking other services.
			</p>
		<p>
...
<strong>(c) DMCA Notices</strong>. If you believe that any Content posted violates your copyright, please notify us at <a href="mailto:support@whichost.com">support@whichost.com</a>. This notice should identify the specific Content and provide us with evidence of your ownership of the copyright or authorisation to enforce the rights of the copyright owner. Any information you provide to us may be shared with other users, third parties, or law enforcement to help assess the claim of infringement or remove infringing content. We will remove any content we determine to be infringing consistent with our obligations under the Digital Millennium Copyright Act (DMCA).
	...
	<h3><strong>2.4 PRIVACY AND DATA USAGE</strong></h3>
      <p>
		...
		<h2>Part 3: Whichost Services</h2>
...
<strong>(b) Conduct and Fees</strong>. You will comply with the Community Guidelines and any Booking Agreements throughout the Booking and use the Pub or Pub Services only as permitted or agreed upon and consistent with the Description, and assure that any attendees do the same. During your Booking, you are responsible for (i) the behaviour and acts of others in attendance that access the Pub, (ii) ensuring that the use does not exceed any limitations identified in the Booking, (iii) complying with applicable Laws. You are responsible for and accept all liability for any damage done to the Pub during your Booking by yourself or others in attendance whether intentional or not, for your failure to comply with applicable Laws, and for any Fines you incur. You agree the Pub and all amenities will be in substantially the same condition as provided to your or as otherwise agreed in any Booking Agreement and consistent with the Community Guidelines, and to promptly notify Pubs of any damage done to the Pub or Amenities.
      ...
      <h3><strong>4.1 TERM, TERMINATION, AND SURVIVAL</strong></h3>
		...
		<p>
<strong>(b) Suspension or Termination by Whichost</strong>. We may suspend your Account--including your ability to communicate with other users or receive payments, or complete a Booking--or terminate this Agreement and your Account at any time including, without limitation, (i) if we believe that use of your Account poses a risk to Whichost, you, other users, or third parties, (ii) actual or potential fraud by you or on your behalf, (iii) your failure to respond to communications from us or other users, or (iv) your failure to comply with this Agreement or applicable Law.
		</p>
		<p>
