...
const listingMinimumPriceSubUnits = 3;
...
const addressCountry = 'IE';
const addressRegion = 'Cork';
const postalCode = 'T12 RD79';
const streetAddress = '16-17 Oliver Plunkett St';
