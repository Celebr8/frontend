	...
	return (
		<Page title={schemaTitle} scrollingDisabled={scrollingDisabled} schema={schema}>
			<LayoutSingleColumnWithHero>
				...
				<LayoutWrapperMain>
				<section>
					<h1>Shape the future of Celebr8</h1>
				...
				<section>
					...
					<p> At Celebr8, we aim to leave this world better than we found it. To achieve this we work with talented people and go above and beyond for our users. <b>We are an early stage startup with initial revenue</b> and a self-funded business with no investors or outside influences except one: our users and what's best for them. We are a startup of execution, full of triers and doers: we try things, we make mistakes, and we learn from them.</p>
					...
					<p>We are seeking a Frontend Engineer Co-founder for our company to accelerate the improvement of our platform, so you won’t have to start from zero! You will be assigned significant equity participation in the company. You will not be required to leave your day job (if you have one) for the time being until we have enough revenue or resources to pay ourselves a living wage. You will also not be required to relocate to Cork in case you are located in a different location. However, after 6 PM we do live and breathe Celebr8, including weekends and holidays (keeping a healthy balance with our personal lives).</p>
					<p>Your responsibilities will be define together with the team, once you are selected!</p>
					<br/>
					<ol><p>Meet the Celebr8 team:</p>
						<li><b>Loic C.:</b> Frontend Engineer with a major in Psychology. Joined Celebr8 in November 2018. <a href="https://angel.co/loic-coenen" target="_blank">AngelList profile</a></li>
						<li><b>Radu S.:</b> Electrical Engineer with 3 startups under his belt. Joined Celebr8 in July 2018. <a href="https://angel.co/radu-sighencea" target="_blank">AngelList profile</a></li>
						<li><b>Carlos R.:</b> Industrial Engineer with 4 startups under his belt. Founded Celebr8 in November 2017. <a href="https://angel.co/carloswhichost" target="_blank">AngelList profile</a></li>
					</ol>
				</section>
				<section>
					<br/>
				...
				<section>
					...
					<p>Being part of Celebr8 isn't like a normal job. We are a startup! We believe in bringing onboard only the best, and as co-founders, we will make all the necessary sacrifices to make Celebr8 as big as possible.</p>
					<p>Celebr8 was born out of a dream. A dream to make finding spaces to host your parties a breeze for everyone, and when we achieve it, we will not stop there. Celebr8 is a stepping-stone towards bigger dreams, more solutions for everyday issues, and better quality of life for every user around the world that we can reach.</p>
