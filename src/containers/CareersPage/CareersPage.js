      ...
      <LayoutSingleColumnWithHero>
        ...
        <LayoutWrapperMain>
          ...
          <section>
            ...
            <ol>
              ...
              <li>
                ...
                November 2018.{' '}
                <a href="https://angel.co/loic-coenen" target="_blank">
                  AngelList profile
                </a>
              </li>
              <li>
                ...
                in July 2018.{' '}
                <a href="https://angel.co/radu-sighencea" target="_blank">
                  AngelList profile
                </a>
              </li>
              <li>
                ...
                <a href="https://angel.co/carloswhichost" target="_blank">
                  AngelList profile
                </a>
              </li>
            </ol>
          ...
          <section>
            ...
            <h2>Specs</h2>
            <p>
              The outcome of starting a company as an entrepreneur is not binary. Building a startup
              is a long-term game with tons of hard work required from lots of people and the right
              things happening at right time hence most of the short-term thinking/judgements do not
              apply.
            </p>
            <p>
              In the last 5-10 years of our startup life, we have been involved in different
              startups and early ventures. Either by founding them or joining afterwards. We've had
              successes and failures and in all cases, we have learned an enormous amount of
              lessons.
            </p>
            <p>
              We have observed a few traits that make a good founding team, hence mentioning them
              below. Please feel free to disagree:
            </p>
            <ol>
              <li>You are aware that execution is king.</li>
              <li>
                You are willing to increase your knowledge/skills just as fast as you dream of
                growing up your startup.
              </li>
              <li>
                You want to live an independent life; you should not have any intention of going
                back to a job or getting an early exit unless the situation demands so.
              </li>
              ...
              <li>
                You are willing to sacrifice weekends, holidays and time off to dedicate to your
                startup growth and development.
              </li>
              <li>
                If you have not founded a company previously, you must have at least one story of
                courage so far.
              </li>
              <li>You have respect for every stakeholder involved.</li>
              <li>
                You have respect for deadlines and understand that not achieving them can have a
                serious impact on the startup growth and development.
              </li>
              <li>You're comfortable with being uncomfortable.</li>
              <li>
                You're able to work well in a fast-paced environment, communicate effectively, and
                remain open to feedback and change.
              </li>
              <li>
                Skills: taking ownership, taking initiative, taking care of people be it employees
                or users or vendors and being very careful with the use of resources.
              </li>
            </ol>
          ...
          <section>
            ...
            <p>
              Being part of Whichost isn't like a normal job. We are a startup! We believe in
              bringing onboard only the best, and as co-founders, we will make all the necessary
              sacrifices to make Whichost as big as possible.
            </p>
            <p>
              Whichost was born out of a dream. A dream to make finding spaces to host your parties
              a breeze for everyone, and when we achieve it, we will not stop there. Whichost is a
              stepping-stone towards bigger dreams, more solutions for everyday issues, and better
              quality of life for every user around the world that we can reach.
            </p>
            <p>
              As co-founders and entrepreneurs, we will continuously work to leave this world better
              than we found it!
            </p>
            <section className={css.getInTouch}>
              ...
              <div className={css.btnGroup + ' ' + css.containerButton}>
                <section className={css.centerButtons}>
                  <form
                    action="https://docs.google.com/forms/d/e/1FAIpQLSdtm06qPOY43w8fY7-BCfsLa1y6NLPqGijoRDGijEYYBMLokQ/viewform"
                    method="get"
                    target="_blank"
                  >
                  ...
                  <form
                    action="https://docs.google.com/forms/d/e/1FAIpQLSfLafaWAW8blKVi99wMeUpUznN6_cmUoDNo3qy58VnXLuo7JA/viewform"
                    method="get"
                    target="_blank"
                  >
