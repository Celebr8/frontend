		...
		<Page title={schemaTitle} scrollingDisabled={scrollingDisabled} schema={schema}>
			<LayoutSideNavigationWithHero>
				...
				<LayoutWrapperMain>
					...
					<p>At the moment we have three active benefits. All linked to attractive rewards and you can read more on the following pages. You can either benefit of our <NamedLink name="BirthdayDealPage">Birthday Gift</NamedLink>, you can reward your employees and colleagues with our <NamedLink name="CorporateDealPage">Corporate Benefit</NamedLink> or you can get a €15 gift card with our <a href="https://www.celebr8.co/benefits/recommend-gift" target="_blank" rel="noopener noreferrer">Recommend Reward</a>.</p>
					<p>What are you waiting for? <a href="https://www.celebr8.co/s?address=Ireland&bounds=55.36%2C-5.911%2C51.427%2C-10.382&origin=53.357%2C-7.756" target="_blank" rel="noopener noreferrer">Find a pub</a> and book it now!</p>
					<br/>
