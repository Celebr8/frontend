    ...
    return (
      <div className={classes.root}>
        ...
        <ExpansionPanel expanded={expanded === 'panel2'} onChange={this.handleChange('panel2')}>
          ...
          <ExpansionPanelDetails>
            <Typography>
              Our marketplace is a platform that allows anyone to create an account in seconds,
              discover pubs, book them and pay hassle free. For businesses, we make it easy to add
              your pub, manage booking requests, message directly to customers, and securely accept
              payments. As a company, we operate the marketplace platform, market pubs to customers,
              support the community, and ensure that both sides have the best experience possible.
            </Typography>
          </ExpansionPanelDetails>
        </ExpansionPanel>
        ...
        <ExpansionPanel expanded={expanded === 'panel5'} onChange={this.handleChange('panel5')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>What if I don't charge for bookings?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel6'} onChange={this.handleChange('panel6')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>What happens when I mark a booking as a No-Show?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel7'} onChange={this.handleChange('panel7')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>
                What if I have a booking fee depending on the number of people coming to the party?
              </b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
        ...
        <ExpansionPanel expanded={expanded === 'panel8'} onChange={this.handleChange('panel8')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>What is the "6% back" that you mention?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
              ...
              <p>
                That's why at Whichost, every three months, we will take 6% of our revenue and
                donate it to local non-profit organisations that are focused on making this world a
                better place.
              </p>
            </Typography>
          </ExpansionPanelDetails>
        ...
        <ExpansionPanel expanded={expanded === 'panel10'} onChange={this.handleChange('panel10')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>How to get good-looking profile pictures?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel12'} onChange={this.handleChange('panel12')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>I don't see my questions here.</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
          ...
          <ExpansionPanelDetails>
            <Typography>
              <ol>
                ...
                <p>
                  Whichost allows you to showcase your pub to the millions of locals and tourists
                ...
                <p>
                  Listing your pub on Whichost opens up a world of new opportunities for new
        ...
        <ExpansionPanel expanded={expanded === 'panel14'} onChange={this.handleChange('panel14')}>
          ...
          <ExpansionPanelDetails>
            <Typography>
              <p>
                Adding your pub to Whichost is easy and only takes a few minutes. Once you’ve
                created a Whichost account, simply click the “+ Add my pub” at the top right. Please
                note that all listings are subject to review by our team to ensure the safety of our
        ...
        <ExpansionPanel expanded={expanded === 'panel15'} onChange={this.handleChange('panel15')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>What are the type of listings available (Common, Private and Free)?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel16'} onChange={this.handleChange('panel16')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>How much does it cost to list my pub?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel17'} onChange={this.handleChange('panel17')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>Do you charge transaction fees for bookings?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel18'} onChange={this.handleChange('panel18')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>Why do you charge transaction fees?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
              <p>
                ...
                investors, we’ve chosen to keep Whichost a self-funded company. We’ve raised € 0.00
                to date and this is something that we're incredibly proud of. We would rather build
                a platform that is so valuable that the community is willing to pay for Whichost, we
        ...
        <ExpansionPanel expanded={expanded === 'panel19'} onChange={this.handleChange('panel19')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>Can I add multiple spaces that I have at my pub?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel20'} onChange={this.handleChange('panel20')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>How to get good-looking listing pictures?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
          ...
          <ExpansionPanelDetails>
            <Typography>
              <p>
                ...
                please take local rates, taxes, Whichost fees, and other fees into consideration
                when listing your hourly rate. You can also make the booking at your pub free.
              </p>
            </Typography>
          </ExpansionPanelDetails>
        </ExpansionPanel>
        <ExpansionPanel expanded={expanded === 'panel22'} onChange={this.handleChange('panel22')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>What information should I put on my listing page, in the description?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel23'} onChange={this.handleChange('panel23')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>What cancellation policy can I use with my listing?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
              <p>
                At Whichost we do not have pre-designed cancellation policies since it is very
                common for users to cancel parties even the same day it was schedule to take place.
        ...
        <ExpansionPanel expanded={expanded === 'panel24'} onChange={this.handleChange('panel24')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>Do I get a unique web address for my listing?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
              <p>
                Yes. Every listing inside Whichost has its own web address that you can copy and
              ...
              <ol>
                ...
                <li>
                  Once the listing loads, you will find your unique listing web address at the top
        ...
        <ExpansionPanel expanded={expanded === 'panel25'} onChange={this.handleChange('panel25')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>How do I add a booking button to my pub's Facebook page?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
              ...
              <ol>
                ...
                <li>Click Next;</li>
                <li>
                  Select "Link to website" from the options and enter your listing web address (see
                  question above to get your listing web address) in the box that will appear;
                </li>
                <li>Click Finish.</li>
              </ol>
        ...
        <ExpansionPanel expanded={expanded === 'panel26'} onChange={this.handleChange('panel26')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>How do I add my payout information?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
              ...
              <ol>
                ...
                <li>
                  On the left navigation, click on “Payments” which will take you to the “Payment
                  settings”;
                </li>
                <li>
                  Enter your contact information (required by Stripe for verification) and bank
                  account information.
                </li>
              </ol>
          ...
          <ExpansionPanelDetails>
            <Typography>
              ...
              <ol>
                ...
                <li>
                  On the left side navigation of your Messages Inbox, select the “Booking Requests”
                  tab;
                </li>
                <li>
                  Click on the booking request messages directly and you will see the option to
                  accept or deny the booking request. Please note that you can also message the
                  customer directly on the request to clarify any details or let them know about
                  availability.
                </li>
              </ol>
            </Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel28'} onChange={this.handleChange('panel28')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>Do I have to accept a booking request?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel30'} onChange={this.handleChange('panel30')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>How do customer reviews work?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel31'} onChange={this.handleChange('panel31')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>Is it possible to edit or delete reviews?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel32'} onChange={this.handleChange('panel32')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>How much time do I have to respond to booking requests?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel33'} onChange={this.handleChange('panel33')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>Can I modify a booking request?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel38'} onChange={this.handleChange('panel38')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>Do I have to report and pay taxes for pub booking income?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
              <p>
                You must also legally report income generated from Whichost to your business and it
        ...
        <ExpansionPanel expanded={expanded === 'panel40'} onChange={this.handleChange('panel40')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>How do I request to book a pub?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
              <p>
                Booking a pub is easy on Whichost and you can do so by creating a user account if
                you have not done so already. Once you do, you can then select a pub listing and
                click “Request to book”. On the next page, you will be able to enter a message to
                the pub regarding how you intend to use it, any specific details, requirements, or
                needs regarding the booking request. You can enter your payment information and send
                the booking request to the pub.
              </p>
              <p>
        ...
        <ExpansionPanel expanded={expanded === 'panel41'} onChange={this.handleChange('panel41')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>
                How do I request a certain time, rate, or option that is not available but indicated
                on the listing?
              </b>
            </Typography>
          </ExpansionPanelSummary>
        ...
        <ExpansionPanel expanded={expanded === 'panel44'} onChange={this.handleChange('panel44')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>How can I cancel my booking?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel46'} onChange={this.handleChange('panel46')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>How long will it take for a pub to respond to my request?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel48'} onChange={this.handleChange('panel48')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>Can I modify a booking once it has been sent as a booking request?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel49'} onChange={this.handleChange('panel49')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>When is a booing confirmed?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
          ...
          <ExpansionPanelDetails>
            <Typography>
              <p>
                ...
                with Whichost. After a booking is used, both the customer and the pub can review
                each other. A review consists of:
              </p>
              <ol>
                <li>A positive or negative rating (thumbs up or down);</li>
                <li>A free-form text comment.</li>
        ...
        <ExpansionPanel expanded={expanded === 'panel55'} onChange={this.handleChange('panel55')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>Do I need insurance for my pub?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel57'} onChange={this.handleChange('panel57')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>
                Do I need customers to sign an agreement, waiver, or any other form of agreement?
              </b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
        ...
        <ExpansionPanel expanded={expanded === 'panel60'} onChange={this.handleChange('panel60')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>How do I reply to messages and booking requests?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
              ...
              <ol>
                ...
                <li>
                  On the left side navigation of your Messages Inbox, select the “My Requests” to
                  see your pub booking requests and “Booking Requests” tab to respond to booking
                  requests.
                </li>
              </ol>
            </Typography>
        ...
        <ExpansionPanel expanded={expanded === 'panel62'} onChange={this.handleChange('panel62')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.headingNoDetails}>
              <b>How can I report a suspicious account activity?</b>
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
