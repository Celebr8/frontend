      ...
      <LayoutSideNavigation>
        ...
        <LayoutWrapperMain>
          <div className={css.content}>
            ...
            <h3>Inclusion</h3>
            <p>We welcome customers of all backgrounds with authentic kindness and open minds. Joining Whichost, as a pub or customer, means becoming part of a community of inclusion. Bias, prejudice, racism, and hatred have no place on our platform or in our community. While hosts are required to follow all applicable laws that prohibit discrimination based on such factors as race, religion, national origin, and others listed below, we commit to do more than comply with the minimum requirements established by law.</p>
            <h3>Respect</h3>
            <p>We are respectful of each other in our interactions and encounters. Whichost appreciates that local laws and cultural norms vary around the world and expects pubs and customers to abide by local laws, and to engage with each other respectfully, even when views may not reflect their beliefs or upbringings. Whichost’s members bring to our community an incredible diversity of background experiences, beliefs, and customs. By connecting people from different backgrounds, Whichost fosters greater understanding and appreciation for the common characteristics shared by all human beings and undermines prejudice rooted in misconception, misinformation, or misunderstanding.</p>
            ...
            <p>Whichost pubs may</p>
            <ol>
              <li>Except as noted above, Whichost pubs may decline to book based on factors that are not prohibited by law. For example, except where prohibited by law, Whichost pubs may decline to book customers with pets, or to customers who smoke.</li>
              ...
              <li>Nothing in this policy prevents a pub from turning down a customer on the basis of a characteristic that is not protected under the civil rights laws or closely associated with a protected class. For example, an Whichost pub may turn down a customer who wants to smoke in a space, or place limits on the number of customers in a space.</li>
            </ol>
            <h3>Turning down customers</h3>
            <p>Pubs should keep in mind that no one likes to be turned down. While a pub may have, and articulate, lawful and legitimate reasons for turning down a potential customer, it may cause that member of our community to feel unwelcome or excluded. Pubs should make every effort to be welcoming to customers of all backgrounds. Pubs who demonstrate a pattern of rejecting customers from a protected class (even while articulating legitimate reasons), undermine the strength of our community by making potential customers feel unwelcome, and Whichost may suspend pubs who have demonstrated such a pattern from the Whichost platform.</p>
            ...
            <p>If a particular listing contains language contrary to this inclusion policy, the pub will be asked to remove the language and affirm his or her understanding and intent to comply with this policy and its underlying principles. Whichost may also, in its discretion, take steps up to and including suspending the host from the Whichost platform.</p>
            <p>If the pub improperly rejects customers on the basis of protected class, or uses language demonstrating that his or her actions were motivated by factors prohibited by this policy, Whichost will take steps to enforce this policy, up to and including suspending the pub from the platform.</p>
            <p>As the Whichost community grows, we will continue to ensure that Whichost’s policies and practices align with our most important goal: To ensure that customers and pubs feel welcome and respected in all of their interactions using the Whichost platform. The public, our community, and we ourselves, expect no less than this.</p>
