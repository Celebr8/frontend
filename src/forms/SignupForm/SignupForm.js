  ...
  <FinalForm
    ...
    render={fieldRenderProps => {
      ...
      const birthdayRequiredMessage = intl.formatMessage({
        id: 'SignupForm.birthdayRequiredMessage',
      });

      const majorityRequiredMessage = intl.formatMessage({
        id: 'SignupForm.majorityRequiredMessage',
      });
      ...
      const birthdayValidators = validators.composeValidators(birthdayRequired, majorityRequired);
