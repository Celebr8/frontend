...
import { FieldCheckbox, FieldTextInput, Form, IconSpinner, NamedLink, PrimaryButton, SavedCardDetails } from '../../components';
...
class StripePaymentForm extends Component {
  ...
  paymentForm(formRenderProps) {
    ...
    const submitDisabled =
      invalid || onetimePaymentNeedsAttention || cardInputNeedsAttention || submitInProgress;
